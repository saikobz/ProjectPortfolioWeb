...
function ProjectImage({ project, locale }: { project: Project; locale: "th" | "en" }) {
  ...
  return (
    <div
      className={`flex items-center justify-center px-6 py-8 md:min-h-full md:px-8 md:py-10 ${
    ...
    <section id="projects" className="mx-auto max-w-5xl px-6 py-16 md:py-24">
      ...
      <div className="mt-10 grid gap-6">
        {projects.map((project) => (
          <article
            key={project.slug}
            className={`group overflow-hidden rounded-2xl border bg-background transition-all hover:-translate-y-0.5 hover:shadow-lg md:grid md:grid-cols-[minmax(0,300px)_1fr] ${
